...
class HazardUpload extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return HazardUploadState();
  }
}

class HazardUploadState extends State<HazardUpload>
    with AutomaticKeepAliveClientMixin<HazardUpload> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((Duration d) {
      if (Global.job?.afterImagesExists == 'false') {
