...
class AddOtherTask extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return AddOtherTaskState();
  }
}

class AddOtherTaskState extends State<AddOtherTask> {
            ...
            onTap: () {
              setState(() {
                if (containsThis(item, index)) {
                  {
                    selectedTask.remove(item);
                    filtered.clear();
                    filtered.addAll(selected);
                  }
                } else
                  selectedTask.add(item);
              });
            },
          );
        });
  ...
  bool containsThis(Task item, int index) {
    if (selectedTask.contains(item)) {
      print('if works');
      return true;
    } else {
      return false;
