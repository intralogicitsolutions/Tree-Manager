...
class ThingRateState extends State<ThingRate> {
  ...
  Widget build(BuildContext context) {
    var items = [
      ...
      {'label': 'Very Low Risk', 'color': 0xff5BEB31, 'value': rates.isNotEmpty ? rates[0].id : null},
      {'label': 'Low Risk', 'color': 0xffC1EB31, 'value': rates.isNotEmpty ? rates[1].id : null},
      {'label': 'Medium Risk', 'color': 0xffEBD831, 'value': rates.isNotEmpty ? rates[2].id : null},
      {'label': 'High Risk', 'color': 0xffEB8831, 'value': rates.isNotEmpty ? rates[3].id : null},
      {'label': 'Very High Risk', 'color': 0xffEB4A31, 'value': rates.isNotEmpty ? rates[4].id : null},
    ];
