...
class TreeDistance extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TreeDistanceState();
  }
}

class TreeDistanceState extends State<TreeDistance> {
  var selected = <String>[];
  var grids = [
    {"label": "0-5", "value": "1"},
    {"label": "6-10", "value": "2"},
  ...
  void initState() {
    try {
      if (Global.site_info_update == true)
        selected = Global.info!.distance!.split(',');
    } catch (e) {}
    super.initState();
  }
                        ...
                        FloatingActionButton(
                          ...
                          onPressed: () {
                            ...
                            if (selected.length != 0) {
                              Global.info!.distance = selected.join(',');
                              Navigator.of(context).pushNamed('tree_access');
                            } else
