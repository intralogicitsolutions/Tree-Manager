...
class TreeHeight extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TreeHeightState();
  }
}

class TreeHeightState extends State<TreeHeight> {
  var selected = <String>[];
  var grids = [
    {"label": "0-5", "value": "1"},
    {"label": "6-10", "value": "2"},
  ...
  void initState() {
    try {
      if (Global.site_info_update == true)
        selected = Global.info!.height!.split(',');
    } catch (e) {}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: Helper.getAppBar(context,
          title: "Tree Height", sub_title: 'Job TM# ${Global.job?.jobNo??''}'),
                      ...
                      FloatingActionButton(
                        ...
                        onPressed: () {
                          ...
                          if (selected.length != 0) {
                            Global.info!.height = selected.join(',');
