...
class FenceWidth extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return FenceWidthState();
  }
}

class FenceWidthState extends State<FenceWidth> {
  var selected = <String>[];
  List<Option> grids = Global.fence_length;

  @override
  void initState() {
    try {
      if (Global.fence!=null) {
        selected = Global.fence!.value2!.split(',');
      }
    } catch (e) {}
    super.initState();
  }
                      ...
                      FloatingActionButton(
                        ...
                        onPressed: () {
                          if (selected.length != 0) {
                            Global.fence?.value2 = selected.join(',');
                            Navigator.of(context).pushNamed('fence_type');
                          } else
